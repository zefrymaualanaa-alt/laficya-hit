...
const OWNER_ID = 8807407436; 
const REQUIRED_CHANNEL = '@laficya'; 
...
function showWelcomeBanner() {
 ...
 ▀▀▀▀ ▀─▀ ▀▀▀▀ ▀▀▀▀ ▀─▀ ▀▀▀▀ ▀─▀▀ 
 ───────────────────────────────────${reset}`);
    console.log(`${cyan}${bold} WELCOME OWNER LAFICYA STORE - WINDOWS LOCAL SYSTEM${reset}`);
...
function logToPanel(type, data) {
    ...
    if (type === 'SATUAN') {
        ...
        console.log(`${magenta}${bold}└── [LAFICYA LOG TRACKER SYSTEM] ──────────────────────────┘${reset}\n`);
    } else if (type === 'BULK') {
        ...
        console.log(`${cyan}${bold}└── [LAFICYA LOG TRACKER SYSTEM] ──────────────────────────┘${reset}\n`);
    }
}
...
bot.start(async (ctx) => {
    ...
    const welcomeText = 
        `<b>[ LAFICYA ENTERPRISE - CONTROL PANEL ]</b>\n` +
        `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
        `English🇬🇧:\n<i>welcome to bot for hit netflix crack automatically, developed by @laficya. Please utilize this utility responsibly and adhere to system regulations to prevent stability issues.</i>\n\nIndoensian🇮🇩\n<i>Selamat datang di bot untuk mendapatkan crack Netflix secara otomatis, yang dikembangkan oleh @laficya. Harap gunakan utilitas ini secara bertanggung jawab dan patuhi peraturan sistem untuk mencegah masalah stabilitas..</i>\n\n` +
        `<blockquote>` +
...
async function processNextHit() {
    ...
    try {
        ...
        const layoutInit = `<b>[ LAFICYA ENTERPRISE - INITIALIZATION CORE ]</b>\n` +
                           `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
        ...
        while (akunDicoba < accounts.length) {
            ...
            const layoutLogin = `<b>[ LAFICYA ENTERPRISE - AUTHENTICATION MODULE ]</b>\n` +
                                `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
            ...
            try {
                ...
                while (shouldContinue) {
                    ...
                    const layoutScraping = `<b>[ LAFICYA ENTERPRISE - EXTRACTION ENGINE ]</b>\n` +
                                           `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
...
// Update progress angka untuk /cekantrian
        ...
        const resultText = `<b>[ LAFICYA ENTERPRISE - TASK EXECUTION COMPLETED ]</b>\n` +
                           `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
        ...
        if (allResults.length > 0) {
            ...
            await ctx.replyWithDocument(
                ...
                { 
                    caption: `<b>[ LAFICYA ENTERPRISE - RESULT SUMMARY ]</b>\n` +
                             `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
                             ...
                             `</blockquote>\n\n` +
                             `English 🇬🇧 :\n` +
                             `<i>Successfully hit cookies, if you want to tidy up the cookie format and check live/dead cookies, please forward this file to the bot @converterlaficyabot so that it can be automatically sorted.</i>\n\n` +
                             `Indonesian 🇮🇩 :\n` +
                             `<i>Berhasil hit cookies, jika ingin merapihkan format cookies dan cek cookies live/dead silahkan forward file ini ke bot @converterlaficyabot agar otomatis di sortir</i>`,
                    parse_mode: 'HTML',
        ...
        try {
            ...
            if (userCurrentMode === 'LINK_TO_COOKIES') {
                const resultText = `✅ successfully logged in and got account cookies!\n\n` +
                                   ...
                                   `Thank you for using this bot, don't forget to follow @laficya`;
...
bot.action(/extract_yes_(.+)/, async (ctx) => {
    ...
    if (liveCookiesResults.length > 0) {
        ...
        await ctx.replyWithDocument(
            ...
            { caption: `🍪 <b>Berhasil Ekstrak: ${liveCookiesResults.length} Cookies</b>\n❌ <b>Gagal/Expired: ${deadLinksResults.length} Link</b>\n\nSilahkan gunakan mode fitur convert cookies to link ke bot @converterlaficyabot agar akun disortir oleh bot.`, parse_mode: 'HTML' }
        );
    } else {
...
bot.action('btn_leaderboard', async (ctx) => {
    ...
    let textLeaderboard = `<b>🏆 TOP 10 RANKING CONVERTER LAFICYA STORE</b>\n─────────────────────────────\n`;
