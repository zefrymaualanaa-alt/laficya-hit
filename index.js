...
bot.start(async (ctx) => {
    ...
    const welcomeText = `<b>[ LAFICYA AUTOMATION SYSTEM ]</b>\n\n` +
        `Selamat datang di sistem otomatisasi LAFICYA. Bot ini berfungsi sebagai mesin extractor otomatis untuk mendapatkan cookies Netflix (Live) secara massal.\n\n` +
