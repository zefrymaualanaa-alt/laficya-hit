...
bot.start(async (ctx) => {
    ...
    const welcomeText = 
        ...
        `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
        `English🇬🇧:\n<i>welcome to bot for hit netflix crack automatically, developed by @bitesw. Please utilize this utility responsibly and adhere to system regulations to prevent stability issues.</i>\n\nIndoensian🇮🇩\n<i>Selamat datang di bot untuk mendapatkan crack Netflix secara otomatis, yang dikembangkan oleh @bitesw. Harap gunakan utilitas ini secara bertanggung jawab dan patuhi peraturan sistem untuk mencegah masalah stabilitas..</i>\n\n` +
        `<blockquote>` +
        ...
        try {
            ...
            if (userCurrentMode === 'LINK_TO_COOKIES') {
                const resultText = `✅ successfully logged in and got account cookies!\n\n` +
                                   ...
                                   `Thank you for using this bot, don't forget to follow @bitesw`;
