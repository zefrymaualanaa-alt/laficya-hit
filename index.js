...
function generateWelcomeText(ctx) {
    ...
    return `<b>[ LAFICYA  NETFLIX HIT ]</b>\n\n` +
...
bot.action('action_menu_bot', (ctx) => {
    ...
    const menuText = `<b>[ PUSAT KENDALI SISTEM ]</b>\n━━━━━━━━━━━━━━━━━━━━━\n\n` +
        `Berikut adalah modul perintah utama yang tersedia di sistem Laficya:\n\n` +
        `<b>🚀 Modul Eksekusi</b>\n` +
...
async function startBotWithRetry() {
    try { await bot.launch({ polling: { timeout: 30 } }); console.log('✅ Sistem Laficya Online & Beroperasi (Mode Terenkripsi)'); } 
